...
<body style="background-color: F5F1F0;">
    ...
    <table class="table table-striped" id="font">
        <tr><th>Booking ID</th><td><?php echo $row['T_No.']; ?></td></tr>
        <tr><th>Name</th><td><?php echo $_SESSION['name']; ?></td></tr>
        <tr><th>Email</th><td><?php echo $_SESSION['email']; ?></td></tr>
        <tr><th>Source Station</th><td><?php echo $_SESSION['source']; ?></td></tr>
        <tr><th>Destination</th><td><?php echo $_SESSION['dest']; ?></td></tr>
        <tr><th>Route</th><td><?php echo $_SESSION['Route']; ?></td></tr>
        <tr><th>Amount</th><td>₹&nbsp&nbsp<?php echo $_SESSION['final']; ?></td></tr>
    </table>

    <table align="center">
        <tr>
            <td>
                <a href="send_ticket_email.php?pid=<?php echo $_SESSION['tno']; ?>" target="_blank">
                    <button style="background-color: black; border-color: black;">
                        <h3><span style="color: white;">Print Ticket</span></h3>
                    </button>
                </a>
            </td>
        </tr>
